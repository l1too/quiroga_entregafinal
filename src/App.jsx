...
const App=()=> {
  ...
  return (
    <main className='container'>
      ...
      <div>
      <h1 className=' text-6xl text-center mb-5'>Lista de Tareas</h1>
        <label className="swap swap-rotate flex justify-center">
      
        <input type="checkbox" onChange={handdleToggle} />
